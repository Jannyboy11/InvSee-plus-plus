...
class SetupImpl implements Setup {
    ...
    static {
        ...
        SUPPORTED.registerSupportedVersion(() -> new Impl_Paper_26_2(), new ServerSoftware(MinecraftPlatform.PAPER, "26.2-rc-2"), ServerSoftware.PAPER_26_2);
...
class Impl_Paper_26_2 extends SetupImpl {
    Impl_Paper_26_2() {
        super(com.janboerman.invsee.paper.addon.give.impl_26_2.GiveImpl.INSTANCE);
    }
}
