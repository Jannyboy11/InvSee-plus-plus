...
class SetupImpl implements Setup {
    ...
    static {
        ...
        SUPPORTED.registerSupportedVersion(() -> new Impl_26_1_1(), ServerSoftware.CRAFTBUKKIT_26_1_1, ServerSoftware.CRAFTBUKKIT_26_1_2, new ServerSoftware(MinecraftPlatform.CRAFTBUKKIT, MinecraftVersion._26_1));
