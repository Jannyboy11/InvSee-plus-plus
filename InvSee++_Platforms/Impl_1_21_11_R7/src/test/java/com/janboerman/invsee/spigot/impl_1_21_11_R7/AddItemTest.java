...
public class AddItemTest {
    ...
    public void testMergeBelowMaxStackSize() {
        contents[0] = itemStack(Material.ENDER_PEARL, 15, 16);

        addItem(itemStack(Material.ENDER_PEARL, 15, 16));

        assertContents(itemStack(Material.ENDER_PEARL, 16, 16), itemStack(Material.ENDER_PEARL, 14, 16));
    }
