...
class MaxStackMeta implements ItemMeta, Damageable {
    ...
    @Override
    public void setDamageTypeKey(NamespacedKey namespacedKey) {
    ...
    @Override
    public @NotNull UseEffectsComponent getUseEffects() {
        return null;
    }

    @Override
    public void setUseEffects(UseEffectsComponent useEffectsComponent) {
    ...
    @Override
    public @NotNull SwingAnimationComponent getSwingAnimation() {
        return null;
    }

    @Override
    public void setSwingAnimation(SwingAnimationComponent swingAnimationComponent) {
    ...
    @Override
    public @NotNull AttackRangeComponent getAttackRange() {
        return null;
    }

    @Override
    public void setAttackRange(AttackRangeComponent attackRangeComponent) {
    ...
    @Override
    public @NotNull PiercingWeaponComponent getPiercingWeapon() {
        return null;
    }

    @Override
    public void setPiercingWeapon(PiercingWeaponComponent piercingWeaponComponent) {
    ...
    @Override
    public @NotNull KineticWeaponComponent getKineticWeapon() {
        return null;
    }

    @Override
    public void setKineticWeapon(KineticWeaponComponent kineticWeaponComponent) {
    ...
    @Override
    public void setMinimumAttackCharge(Float aFloat) {
