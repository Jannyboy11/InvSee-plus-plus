...
public class BungeeCordStrategy implements UUIDResolveStrategy, PluginMessageListener {
    ...
    public CompletableFuture<Optional<UUID>> resolveUUID(String userName) {
        ...
        if (player == null) return (CompletableFuture<Optional<UUID>>) InvseeAPI.COMPLETED_EMPTY;
        ...
        try {
            ...
            return (CompletableFuture<Optional<UUID>>) InvseeAPI.COMPLETED_EMPTY;
        }
    }
        ...
        if (BUNGEECORD_CHANNEL.equals(channel)) {
            ...
            try {
                ...
                if (UUIDOther_SUBCHANNEL.equals(subChannel)) {
                    ...
                    if (future != null) {
                        future.complete(Optional.of(UUID.fromString(uuid)));
                    }
                }
            } catch (IOException e) {
