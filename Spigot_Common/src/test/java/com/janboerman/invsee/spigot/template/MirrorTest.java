...
public class MirrorTest {
    ...
    private static final PlayerInventorySlot[] EXPECTED_PLAYER_INVENTORY_TEMPLATE = new PlayerInventorySlot[] {
    ...
    private static final EnderChestSlot[] EXPECTED_ENDER_CHEST_TEMPLATE = new EnderChestSlot[] {
    ...
    public void testInventory() {
        ...
        assertArrayEquals(EXPECTED_PLAYER_INVENTORY_TEMPLATE, template.getSlots());
    }
