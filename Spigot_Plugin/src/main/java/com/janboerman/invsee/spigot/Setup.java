...
public interface Setup {
    ...
    public static Setup setup(Plugin plugin) {
        ...
        if (server.getClass().getSimpleName().equals("CraftServer")) {
            throw new RuntimeException("Unsupported CraftBukkit version. Please run on one of [1.8.8, 1.12.2, 1.15.2, 1.16.5, 1.17.1, 1.18.2, 1.19.2, 1.19.3, 1.19.4]. Are you running the latest InvSee++?");
        } else {
